# Smart Worker — Claude Cowork 플러그인 마켓플레이스
...
동기화가 완료되면 **smart work** 플러그인이 목록에 나타납니다. **설치** 버튼을 클릭하면 **12종 스킬**이 자동 활성화되고, **5종 슬래시 커맨드**를 `/`로 호출할 수 있습니다.
...
| 플러그인                                    | 스킬 | 커맨드 | 설명                                                    |
| ------------------------------------------- | ---- | ------ | ------------------------------------------------------- |
| **[smart work](smart-cowork-life/)** | 12종 | 5종    | 이메일, 보고서, 회의록, 제안서, 엑셀, 번역, PPT, SVG 등 |
